...
function TodoItem({ todo, onToggle, onEdit, onDelete }) {
    ...
    const [editText, setEditText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(todo.todo);
    const handleEdit = ()=>{
        if (isEditing) {
            if (editText.trim()) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
        ...
        children: [
            isEditing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                className: `flex-1 cursor-pointer p-2 ${todo.completed ? 'line-through text-gray-500' : 'text-gray-900'}`,
                children: todo.todo
            }, void 0, false, {
                fileName: "[project]/src/components/TodoItem.tsx",
                lineNumber: 40,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: `ml-4 px-3 py-1 rounded text-sm font-medium transition-colors ${todo.completed ? 'bg-green-100 text-green-800 hover:bg-green-200' : 'bg-red-100 text-red-800 hover:bg-red-200'}`,
                children: todo.completed ? 'Completed' : 'Incomplete'
            }, void 0, false, {
                fileName: "[project]/src/components/TodoItem.tsx",
                lineNumber: 49,
                columnNumber: 7
...
_s(TodoItem, "30yVJyRHSivvSj6KVKCRfgWo+I0=");
_c = TodoItem;
var _c;
...
;
const todoApi = {
    getTodos: async (page, limit, search, status)=>{
...
function TodoList() {
    ...
    const { data, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "TodoList.useQuery": ()=>todoApi.getTodos(page, limit, searchText, filterStatus)
        }["TodoList.useQuery"],
        staleTime: 5 * 60 * 1000
    });
    const addMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: {
            "TodoList.useMutation[addMutation]": ()=>{
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "TodoList.useMutation[updateMutation]": ({ id, data })=>todoApi.updateTodo(id, data)
        }["TodoList.useMutation[updateMutation]"],
        onSuccess: {
            "TodoList.useMutation[updateMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: {
            "TodoList.useMutation[deleteMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
                        'todos'
                    ]
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "max-w-2xl mx-auto p-4 bg-[#3a66bf]",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: addMutation.isPending ? 'Adding...' : 'Add Task'
                    }, void 0, false, {
                        fileName: "[project]/src/components/TodoList.tsx",
                        lineNumber: 122,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                ...
                children: !data || data.data.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                    className: "text-center py-8 font-bold text-[#f1bcbc]",
                    children: "NO TODOS FOUND."
                }, void 0, false, {
                    fileName: "[project]/src/components/TodoList.tsx",
                    lineNumber: 157,
                    columnNumber: 11
                }, this) : data.data.map((todo)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TodoItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        todo: todo,
...
_s(TodoList, "phli3pMBgK2K5FDC6b1P/XEqoNc=", false, function() {
    return [
...
//# sourceMappingURL=_0f501446._.js.map